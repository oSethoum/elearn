...
INSERT INTO "new_Lesson" ("content", "courseId", "createdAt", "description", "id", "published", "title", "updatedAt") SELECT "content", "courseId", "createdAt", "description", "id", "published", "title", "updatedAt" FROM "Lesson";
DROP TABLE "Lesson";
