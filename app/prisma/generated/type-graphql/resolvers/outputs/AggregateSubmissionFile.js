...
exports.AggregateSubmissionFile = void 0;
...
let AggregateSubmissionFile = class AggregateSubmissionFile {
    _count;
    _avg;
    _sum;
    _min;
...
], AggregateSubmissionFile.prototype, "_count", void 0);
__decorate([
    TypeGraphQL.Field(_type => SubmissionFileAvgAggregate_1.SubmissionFileAvgAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateSubmissionFile.prototype, "_avg", void 0);
__decorate([
    TypeGraphQL.Field(_type => SubmissionFileSumAggregate_1.SubmissionFileSumAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateSubmissionFile.prototype, "_sum", void 0);
__decorate([
    TypeGraphQL.Field(_type => SubmissionFileMinAggregate_1.SubmissionFileMinAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateSubmissionFile.prototype, "_min", void 0);
__decorate([
    TypeGraphQL.Field(_type => SubmissionFileMaxAggregate_1.SubmissionFileMaxAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateSubmissionFile.prototype, "_max", void 0);
AggregateSubmissionFile = __decorate([
    TypeGraphQL.ObjectType("AggregateSubmissionFile", {
        isAbstract: true
    })
], AggregateSubmissionFile);
exports.AggregateSubmissionFile = AggregateSubmissionFile;
